...
export default function FastagPage() {
  ...
  useEffect(() => {
    if (!account?.nishchint_insight.has_issue) {
      setPageContext(null);
      return;
    }
    setPageContext({
      summary: "your FASTag recharge",
      suggestedMessage: "Your recharge succeeded, but the FASTag balance hasn't fully updated — can you check on this?",
    });
    return () => setPageContext(null);
  }, [account, setPageContext]);
